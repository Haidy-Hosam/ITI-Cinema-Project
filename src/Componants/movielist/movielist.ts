...
export class Movielist {
  favorites: any[] = [];
  alerts: string | null = null; // الرسالة اللي هتتعرض فوق
  ...
  toggleFavorite(movie: any) {
    ...
    if (index > -1) {
      ...
      this.showSuccessAlert(`${movie.title} تم الحذف ❌`);
    } else {
      this.favorites.push(movie);
      this.showSuccessAlert('Done ✅'); // هنا الرسالة الجديدة
    }
  }
  ...
  list_of_movies=[
    ...
    },
    {
      ...
      "genre_ids": [16, 28, 12, 35, 10751, 14, 10402],
      "id": 803796,
      "original_language": "en",
